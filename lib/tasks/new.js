...
const GIT_SETUP_CMD = "git init && git add . && git commit -am 'Qnorr initial commit.'";
...
function run(args) {
  ...
  if(!environment.project_name) {
    ...
    console.error("See qnorr help for command instructions");
    exit(1);
  }
...
module.exports = {
  handler: run,
  usage: "qnorr new <project-name>",
  description: "Creates a new project using qnorr in a new folder with the specified name."
}
